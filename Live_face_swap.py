...
img2, landmarks2=read_im_and_landmarks("kareena.jpg")
...
while True:
   ...
   img1 = cv2.resize(img1,None,fx=0.75,fy=0.75, interpolation=cv2.INTER_LINEAR )
   ...
   cv2.imwrite('output_live.jpg', output_im)
   output = cv2.imread("output_live.jpg")
   cv2.imshow("swapped  ", output)
   sleep(0.5)
